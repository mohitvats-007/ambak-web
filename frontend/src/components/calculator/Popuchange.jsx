          ...
          <div className="popup-inner">
            <div className='radio_cross_cont'>
                <select name="partner" id="">
                    <option value="as">partners1</option>
                    <option value="as">partners2</option>
                    <option value="as">partners3</option>
                    <option value="as">partners4</option>
                </select>
                <button>Apply</button>
