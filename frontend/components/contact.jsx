...
const Contact = () => {
  ...
  const submitHandler = (event) => {
    ...
    axios({
      ...
      .then((res) => {
        ...
        console.log("id inside" + id), console.log(res);
        event.target.reset();
      })
      .catch((err) => {
        console.log(err);
  ...
  const removeRow = (id, index) => {
    ...
    if (!confirmed) {
      ...
      axios
        .post(`http://localhost:8081/setstatus/${id}`)
        .then((res) => {
      ...
      <form className="container" onSubmit={submitHandler}>
        ...
        <div className="container2">
          <div className="input1">
            <label className="nametext" htmlFor="name">
              Name
            </label>
            <input
              type="text"
            ...
            />
            <label className="phonenumber" htmlFor="name">
              Ph.no
            </label>
            <input
              type="number"
          ...
          <div className="input2">
            <label htmlFor="mail" className="email">
              Email ID :
            </label>
            <input
              type="text"
          ...
          <div className="input4">
            <button className="name" type="submit" id="button">
              Save
            </button>
          </div>
        </div>
      ...
      <table className="table table-bordered text-wrap">
        ...
        <td>{user?.address || ""}</td> */}
                  ...
                  <td>
                    ...
                    >
                      <img
                        src="https://cdn.hugeicons.com/icons/pencil-edit-01-stroke-rounded.svg"
                        alt="pencil-edit-01"
                        width="24"
                        height="24"
                      />
                  ...
                  <td>
                    <button
                      onClick={() => removeRow(user.id, index)}
                      type="button"
