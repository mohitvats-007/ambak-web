...
const HomeSvg = () => (
  <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" width="24" height="24" color="#000000" fill="none">
    ...
    <path d="M11.9959 7H12.0049" stroke="currentColor" />
    <path d="M4 10V18.5M8 10V18.5" stroke="currentColor"  />
    <path d="M16 10V18.5M20 10V18.5" stroke="currentColor"  />
    <path d="M19 18.5H5C3.34315 18.5 2 19.8431 2 21.5C2 21.7761 2.22386 22 2.5 22H21.5C21.7761 22 22 21.7761 22 21.5C22 19.8431 20.6569 18.5 19 18.5Z" stroke="currentColor" />
</svg>
